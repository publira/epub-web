...
export const PrivacyDialog = ({ dialogRef }: PrivacyDialogProps) => (
  <Dialog aria-labelledby="privacy-dialog-title" dialogRef={dialogRef}>
    <DialogContent>
      ...
      <h2 className="font-heading m-0 text-xl" id="privacy-dialog-title">
        プライバシーポリシー
      </h2>
      <h3 className="text-primary/90 mt-4 mb-0 text-sm font-semibold">
        1. 基本方針
      </h3>
      ...
      <h3 className="text-primary/90 mt-5 mb-0 text-sm font-semibold">
        2. 収集する情報と利用目的
      </h3>
