...
const ReaderNavigationButton = ({
  ...
  return direction === "previous" ? (
    <ComicViewer.PreviousPageButton
      aria-label={intl.formatMessage({ id: "comicViewer.previousPage" })}
    ...
    <ComicViewer.NextPageButton
      aria-label={intl.formatMessage({ id: "comicViewer.nextPage" })}
      className={buttonClassName}
    >
      {children}
    </ComicViewer.NextPageButton>
...
export const ReaderPageNavigation = () => {
  ...
  return (
    <ComicViewer.PageNavigation
      aria-label={intl.formatMessage({ id: "comicViewer.navigation" })}
            ...
            intl.formatMessage(
              {
                id:
                  firstPage === lastPage
                    ? "comicViewer.pageSingle"
                    : "comicViewer.pageRange",
              },
              { count: pageCount, first: firstPage, last: lastPage }
            )
          }
        />
      </ComicViewer.PageProgress>
